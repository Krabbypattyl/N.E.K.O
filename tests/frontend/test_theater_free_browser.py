...
def test_free_page_restores_history_and_keeps_failed_draft(mock_page: Page, running_server: str):
    ...
    expect(mock_page.locator(".numeric-theater-stage")).to_be_visible()
    expect(mock_page.locator(".numeric-theater-console")).to_be_visible()
    expect(mock_page.locator(".theater-stage-toggle-icon")).to_have_text("←")
