...
状态：**DS-01 已合并重复投影，DS-02 已对齐作者说明，匹配回归通过**。实际优化与验收边界统一见[问题与处理 2.125](./neko-theater-issues-and-solutions.md)。下文保留优化前的数据合同审查证据、行号和建议；“当前”“本轮”及原检查数量均指审查时点，不是现行待办。正式 schema 与旧字段保留，未迁移作者项目、剧本包或玩家存档。
